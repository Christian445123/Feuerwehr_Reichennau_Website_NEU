            ...
            <ul class="nav-menu" id="navMenu">
                <li class="nav-dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="index.php?page=berichte&year=archiv">Archiv</a></li>
                    </ul>
                </li>
                <li class="nav-dropdown">
                ...
                <li class="nav-dropdown">
                    <a href="index.php?page=feuer" class="nav-link <?php echo in_array($current_page, ['feuer', 'technik', 'gefahrgut'], true) ? 'active' : ''; ?>"><i class="fas fa-triangle-exclamation"></i> Einsatzbereiche <i class="fas fa-chevron-down dropdown-arrow"></i></a>
                    <ul class="dropdown-menu">
